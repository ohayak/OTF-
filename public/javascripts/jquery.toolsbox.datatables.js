...
function getLendIconPng(label, route, idField, nameField){
  var sep = "?";
  if(route.indexOf('?') !== -1)
    sep = "&";

  console.log("## getLendIconPng !!!");
    if(convertUndefined(idField) === "")
        idField = idName;
    if(convertUndefined(nameField) === "")
        nameField = idField;
    ...
    var LendIconPng = {
        ...
        "mData": function (x) {
            if (isNullOrUndefined(x[idField]) || x[idField] === 0)
                ...
                return '<a href="'+route+sep+nameField+'='+x[idField]+'" title="'+label+'" class="btn btn-xs btn-default"><i class="fa fa-arrow-circle-right fa-2x"></i></a>';
        },
        "bSortable": false
    };
    return LendIconPng;
    ...
    var ReturnIconPng = {
        ...
        "mData": function (x) {
            if (isNullOrUndefined(x[idField]) || x[idField] === 0)
                ...
                return '<a href="'+route+sep+nameField+'='+x[idField]+'" title="'+label+'" class="btn btn-xs btn-default"><i class="fa fa-arrow-circle-left fa-2x"></i></a>';
        },
        "bSortable": false
    };
    return ReturnIconPng;
}
